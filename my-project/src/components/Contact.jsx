...
import contact from '../assets/image.png'
  ...
  return (
    <div>
        <div className='relative'>
            ...
            className='absolute top-10 lg:left-32 mx-auto lg:pl-16 w-[400] px-7 lg:px-0' >
                    ...
                    <form action="" className='bg-red-50 rounded-lg p-10 space-y-4'>
                        ...
                        <button className='bg-red-500 text-whight px-4 py-2 rounded-lg'>Send</button>
                    </form>
                </motion.div>
        </div>
    </div>
