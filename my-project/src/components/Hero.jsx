...
import { FadeRight, FadeUp } from '../utility/Aninmation'
const Hero = () => {
  return (
    <div className='bg-[#201F1F] relative z-10 overflow-x-hidden lg:overflow-x-visible'>
        <div className="max-w-7xl mx-auto">
            <div className="flex flex-col gep-6 lg:flex-row h-screen lg:h-[650px] lg:justify-center items-center">
                {/*hero*/}
                <div className="lg:w-1/2  flex flex-col lg:flex  px-8 space-y-5 justfiy-center lg:pt-0 pt-12">
                  <motion.h3
                  variants={FadeRight(0.5)}
                  initial="hidden"
                  animate="visible"
                   className='text-red-500 text-lg lg:text-xl'>On Demand Purchase________</motion.h3>
                  <motion.h1
                  variants={FadeRight(0.9)}
                  initial="hidden"
                  animate="visible" className='text-4xl lg:text-6xl font-bold text-white'>Experience the Thrill of <span className='text-red-500'>Super Cars</span> </motion.h1>
                  <motion.p 
                  variants={FadeRight(1)}
                  initial="hidden"
                  animate="visible"
                  className='text-white text-sn'>Discover the world's most exclusive and hidh-performance vehices.From blistering speed to unparalleled luxury, our super cars redefine the limits of automotive engineering.
                  </motion.p>
                  <div className="flex gap-4 items-center ">
                    ...
                    initial="hidden"
                    animate="visible"
                    className='bg-white text-black rounded-full px-4 py-2 font-semibold items-center'>Book a Test drive</motion.button>
                  </div>
                  <motion.div
                  variants={FadeUp(1.8)}
                  initial="hidden"
                  animate="visible"
                  className='flex flex-col lg:flex-row gap-2 text-white pt-7 gap-5 flex'>
                ...
                <div className="flex gap-3 items-center">
                    ...
                    <div className='flex flex-col gap-2'>
                        ...
                        <select className='border border-gray-300 rounded-sm p-1'>
                            ...
                            <option value="">Mercedes</option> <option value="">BMW</option> <option value="">Lamborghini</option> <option value="">Porshe</option>
